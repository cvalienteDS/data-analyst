...
```
Se observa que company tiene demasiada granularidad para usarlo en el análisis. Además, si nosotros somos la productora "Martínez" no podríamos elegir ser Universal.
